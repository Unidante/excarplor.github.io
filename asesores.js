// Función para alternar la visibilidad de los detalles del asesor - definida globalmente
function toggleAdvisorDetails(card) {
    const details = card.querySelector('.advisor-details');
    if (details) {
